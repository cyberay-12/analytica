...
export default function PresentationDashboard() {
  ...
  const getData = () => {
    ...
    axiosClient.get('/rdpresentation', {
      params: filters
    })
    .then(({data}) => {
      setLoading(false);
        ...
        <div className="px-6 pt-4">
            <div className="grid grid-cols-4 md:grid-cols-12 gap-3 mb-2">
                <div className="col-span-4">       
                        <div>
                            <MainCard number={data?.stats?.total_pub} title="Total Presentations" />
                        </div>
                        <div className="mt-3">
                            ...
                            </span>} title={`New Presentations in ${data?.stats?.max_year}`}/>
                        </div>
                </div>
                        ...
                        <Plotly 
                            ...
                            layout={{
                                ...
                                legend: {
                                    ...
                                    xanchor: 'right', 
                                    y: 1.3,         // Moves it slightly above the plot line
            ...
            <div className="grid grid-cols-3 sm:grid-cols-12 gap-3">
                <div className="col-span-3 h-96 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Presentations per Category</div>
                ...
                <div className="col-span-3 h-96 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Presentations per Type</div>
                        <div className='row-span-6 h-full w-full'>
                        <Plotly 
                            data={[{
                ...
                <div className="col-span-3 h-96 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Presentations per Level</div>
                        <div className='row-span-6 h-full w-full'>
                        <Plotly 
                            data={[{
                ...
                <div className="col-span-3 h-96 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl mb-5">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Presentations per Unit</div>
                        <div className='row-span-6 h-full w-full'>
                        <Plotly 
                            data={[{
