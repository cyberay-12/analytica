...
export default function LinkageDashboard() {
    ...
    <div>
      ...
      <div className="grid grid-cols-12 h-16 sm:h-8 bg-gray-400/50 content-around">
        ...
        <div className="px-6 pt-4">
            <div className="grid grid-cols-3 md:grid-cols-12 gap-3 mb-2">
                <div className="col-span-3">       
                        <div>
                            <MainCard number={data?.stats?.total_link} title="Total Linkages" />
                        </div>
                        <div className="mt-3">
                            <SecCard number={data?.stats?.new_link} percent={<span className={data?.percentages?.year_percent > 0 ? 'text-green-600' : 'text-red-600'}>
                            {data?.percentages?.year_percent > 0 ? '▲' : '▼'} {data?.percentages?.year_percent}%
                            </span>} title={`New Linkages in ${data?.stats?.max_year}`}/>
                        </div>
                </div>
                        ...
                        <Plotly 
                            ...
                            layout={{
                                ...
                                legend: {
                                    ...
                                    xanchor: 'right', 
                                    y: 1.1,         // Moves it slightly above the plot line
                ...
                <div className="col-span-3 h-75 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Linkages per Status</div>
                        <div className='row-span-6 h-full w-full'>
                        <Plotly 
                            data={[{
                                values: data?.charts?.per_status_values,
                                labels: data?.charts?.per_status_labels,
            ...
            <div className="grid grid-cols-3 sm:grid-cols-12 gap-3">
                <div className="col-span-3 h-96 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Awards per Category</div>
                        <div className='row-span-6 h-full w-full'>
                        <Plotly 
                            data={[{
                ...
                <div className="col-span-3 h-96 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Awards per Type</div>
                        <div className='row-span-6 h-full w-full'>
                        <Plotly 
                            data={[{
                ...
                <div className="col-span-3 h-96 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Awards per Level</div>
                        <div className='row-span-6 h-full w-full'>
                        <Plotly 
                            data={[{
                ...
                <div className="col-span-3 h-96 border-t-6 border-green-600 bg-white rounded-[1vw] inset-shadow-xl shadow-xl mb-5">
                    <div className='grid grid-rows-7 h-full'>
                        <div className='row-span-1 font-[750] text-lg text-gray-700 w-full rounded-t-[1vw] align-middle pt-4 pl-7'>Awards per Unit</div>
                        <div className='row-span-6 h-full w-full'>
                        <Plotly 
                            data={[{
